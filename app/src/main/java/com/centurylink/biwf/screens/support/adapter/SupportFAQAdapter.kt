 ...
 */
class SupportFAQAdapter(private val mContext: Context, private var faqListItems: MutableList<FaqTopicsItem>) : RecyclerView.Adapter<CustomViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomViewHolder {
        return CustomViewHolder(LayoutInflater.from(mContext).inflate(R.layout.widget_faq_section,parent,false))
    }
