...
class AnalyticsKeys {
    companion object {
        ...
        const val BUTTON_BACK_CANCEL_SUBSCRIPTION_CONFIRMATION =
            "Back Button Cancel Subscription Confirmation"
        ...
        const val BUTTON_SUBMIT_CANCEL_SUBSCRIPTION_CONFIRMATION =
            "Submit Button Cancel Subscription Confirmation"

        /*Devices Module*/
        const val BUTTON_CANCEL_CANCEL_SUBSCRIPTION_CONFIRMATION =
            "Cancel Button Cancel Subscription Confirmation"
        ...
        const val BUTTON_DEVICE_CONNECTION_STATUS_DEVICE_DETAILS =
            "Connection Status Button Devices Details"
        ...
        const val ALERT_CANCEL_SUBSCRIPTION_KEEP_SERVICE =
            "Keep Service Cancel Subscription Confirmation"
        const val ALERT_CANCEL_SUBSCRIPTION_CANCEL_SERVICE =
            "Cancel Service Cancel Subscription Confirmation"
        const val ALERT_REMOVED_DEVICES_RESTORE_ACCESS =
            "Restore-Access Removed Devices Confirmation"
        const val ALERT_REMOVED_DEVICES_CANCEL_ACCESS =
            "Cancel Restore-Access Removed Devices Confirmation"
        const val ALERT_REMOVE_CONFIRMATION_USAGE_DETAILS =
            "Remove Device Confirmation Devices Details"
